        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('specifications.update', $specification) }}">
                    ...
                    <x-ai-improvable-field field="description" :label="__('Description')" :model="$specification" />

                    <x-ai-improvable-field field="goals" :label="__('Goals')" :model="$specification" />

                    <x-ai-improvable-field field="scope" :label="__('Scope')" :model="$specification" />

                    <x-ai-improvable-field field="functional_requirements" :label="__('Functional Requirements')" :rows="4" :model="$specification" />

                    <x-ai-improvable-field field="non_functional_requirements" :label="__('Non-Functional Requirements')" :rows="4" :model="$specification" />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="divide-y divide-gray-200">
                    <x-ai-assistance-panel field="description" :label="__('Description')" :model="$specification" :ai-request="$latestAiRequests->get('description')" />
                    <x-ai-assistance-panel field="goals" :label="__('Goals')" :model="$specification" :ai-request="$latestAiRequests->get('goals')" />
                    <x-ai-assistance-panel field="scope" :label="__('Scope')" :model="$specification" :ai-request="$latestAiRequests->get('scope')" />
                    <x-ai-assistance-panel field="functional_requirements" :label="__('Functional Requirements')" :model="$specification" :ai-request="$latestAiRequests->get('functional_requirements')" />
                    <x-ai-assistance-panel field="non_functional_requirements" :label="__('Non-Functional Requirements')" :model="$specification" :ai-request="$latestAiRequests->get('non_functional_requirements')" />
                </div>
            </div>
